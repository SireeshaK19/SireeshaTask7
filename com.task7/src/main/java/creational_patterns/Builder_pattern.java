...
public class Builder_pattern {
    ...
    private final String address; // optional
	    ...
	    public static void main(String[] args) {
	        Builder_pattern user1 = new Builder_pattern.UserBuilder("prerna", "sri")
	        .age(20)
	        .phone("9845674539")
	        .address("address 17-87")
	        .build();
	     
	        System.out.println(user1);
	     
	        Builder_pattern user2 = new Builder_pattern.UserBuilder("likitha", "reddy")
	        .age(30)
	        .phone("7866678556")
	        //no address
	        .build();
	        ...
	        Builder_pattern user3 = new Builder_pattern.UserBuilder("Sri", "Reddy")
	        .age(45)
	        //No phone
	        //no address
	        .build();
